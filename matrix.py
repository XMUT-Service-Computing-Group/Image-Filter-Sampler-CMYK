...
def GUI():
    ...
    path = tk.Entry(window, width=53)
    path.place(x=110, y=25)
    path.insert(0, '')
    label2 = tk.Label(window, text='变化幅度[0,50]：')
    ...
    label3.place(x=240, y=65)

    label31 = tk.Label(window, text='单色：')
    label31.place(x=350, y=95)

    counts = tk.Entry(window, width=5)
    counts.place(x=390, y=95)
    counts.insert(0, 0)

    label32 = tk.Label(window, text='双色：')
    label32.place(x=350, y=125)

    countd = tk.Entry(window, width=5)
    countd.place(x=390, y=125)
    countd.insert(0, 0)

    label33 = tk.Label(window, text='三色：')
    label33.place(x=350, y=155)

    countt = tk.Entry(window, width=5)
    countt.place(x=390, y=155)
    countt.insert(0, 0)

    label34 = tk.Label(window, text='四色：')
    label34.place(x=350, y=185)

    countq = tk.Entry(window, width=5)
    countq.place(x=390, y=185)
    countq.insert(0, 0)

    button2 = tk.Button(window, width=56, height=2, text='生成', font='宋体',
